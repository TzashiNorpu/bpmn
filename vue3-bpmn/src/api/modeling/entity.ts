import type {
  ModelingEntityAddParam,
  ModelingEntityFindParam,
  ModelingEntityInstanceAddParam,
  ModelingEntityInstanceDeleteParam,
  ModelingEntityInstanceFindParam,
  ModelingEntityInstanceUpdateParam,
  ModelingEntityUpdateParam,
  ModelingEntityView,
} from '@/types/modeling/entity'
...
export function getInstance(params: ModelingEntityInstanceFindParam) {
  return request<Record<string, MYANY>>({
    url: `/modeling/entity/instance`,
    method: 'GET',
    params,
  })
